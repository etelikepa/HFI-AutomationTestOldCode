...
Then("The Reagent API of user stories Expired Reagent will respond with status {arg}", function (theExpectedStatus)
{
...
{
  var myPropertyValue = aqObject.GetPropertyValue(respondedDataJson, theProperty);
